...
class Optimizesilver:
    ...
    SILVER_TABLES = [
        ("s_apps", "eth_blocks",                 "block_number"),
        ("s_apps", "eth_blocks_withdrawals",     "block_number"),
        ("s_apps", "eth_transactions_staging",   "block_number"),
        ("s_apps", "transactions_ethereum",      "block_number"),
        ("s_apps", "eth_canonical_blocks_index", "block_number"),
