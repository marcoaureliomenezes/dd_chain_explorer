...
# Lifecycle: move to Infrequent Access after 90 days (no Glacier — Databricks needs random access)
...
# Lifecycle: move to Infrequent Access after 90 days; expire checkpoints after 365 days
